...
#ifndef NICLA_TEST_GAS_SENSOR_NICLA_H
#define NICLA_TEST_GAS_SENSOR_NICLA_H

#include "Arduino_BHY2.h"
#include "sensor/SensorInterface.h"
#include "SensorID_Nicla.h"

extern Sensor gas_detector;

class GAS_Sensor_Nicla: public SensorInterface {
public:
    void start() override;
    void end() override;
...
#endif //NICLA_TEST_GAS_SENSOR_NICLA_H
#endif
