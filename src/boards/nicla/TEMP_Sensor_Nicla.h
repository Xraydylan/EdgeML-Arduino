...
#ifndef NICLA_TEST_TEMP_SENSOR_NICLA_H
#define NICLA_TEST_TEMP_SENSOR_NICLA_H
...
class TEMP_Sensor_Nicla: public SensorInterface {
public:
    void start() override;
    void end() override;
...
#endif //NICLA_TEST_TEMP_SENSOR_NICLA_H
